...
\chapter{Pressions temporelles, partie 2}

\emph{[Ndt: \textbf{ATTENTION Double chapitre}  ! Si vous n'avez pas encore lu le chapitre 88, allez-y et revenez ici ensuite.]} 
...
De derrière Harry vint le son d'un autre mugissement du troll, il entendit l'un des jumeaux Weasley crier "\emph{Deligitor prodeas !} " puis : "\emph{À L'AIDE ! Fais quelque chose !} "
...
"\emph{Fred !} " s'écria George Weasley, puis :"\emph{VENTUS !} "
...
\textbf{\emph{"IL EST LÀ. CELUI QUI DÉCHIRERA LES ÉTOILES DU CIEL. IL EST LÀ. IL EST LA FIN DU MONDE."} } 
